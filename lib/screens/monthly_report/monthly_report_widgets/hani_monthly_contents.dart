...
class HaniMonthlyContents extends StatefulWidget {
  final String classType;

  const HaniMonthlyContents({super.key, required this.classType});

  @override
  State<HaniMonthlyContents> createState() => _HaniMonthlyContentsState();
}

class _HaniMonthlyContentsState extends State<HaniMonthlyContents> {
  final dataList = Get.find<HaniMonthlyReportDataController>().haniMonthlyReportDataList;
  ...
  Widget build(BuildContext context) {
    return Obx(
      () {
        ...
        return Container(
          decoration: BoxDecoration(color: Color(0xFFFCEFEE)),
          child: SingleChildScrollView(
            child: Column(
              children: [
                Padding(
                  padding: EdgeInsets.only(top: 24.0),
                  child: Image.asset('assets/images/icon/hani.png', scale: 2),
                ),
                Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: HaniSummary(classType: widget.classType),
                      ),
                    ),
                  ),
                ),
                                        ...
                                        Expanded(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                firstItem.notes[index].isNotEmpty
                                                    ? WordBreakText(
